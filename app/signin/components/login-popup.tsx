          ...
          <div className=" flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2 sm:mb-2">
              <div>
                ...
                <p className="text-gray-500 text-[12px] sm:text-[12px]">
                  Enter email & password to get started
                </p>
              </div>
              {/* Updated Register button */}
              <button
                onClick={onBackToAuth}
                className="bg-[#faf9f7] mr-14 text-[#e0622c] font-medium hover:bg-[#f5f5f0] transition-colors flex items-center justify-center"
                style={{
                  width: "100px",
                  height: "36px",
                  borderRadius: "100px",
            ...
            <div className="space-y-2 sm:space-y-1 mb-1 sm:mb-2">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  ...
                  <span className="ml-3 text-black text-base">Remember me</span>
                </label>
                <button
