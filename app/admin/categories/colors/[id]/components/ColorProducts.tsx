...
export default function ColorProducts({ products, total, currentPage, totalPages }: ColorProductsProps) {
                ...
                <div className="text-center py-12">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        {searchQuery || activeFilter !== 'all'
                            ...
                            : 'This color has no products yet'}
                    </p>
                </div>
            )}
        </div>
