...
export default async function ProductManagementPage(props: {
    ...
    const dressStyle = typeof searchParams.dressStyle === 'string' ? searchParams.dressStyle : undefined;
    ...
    const [categoriesData, dressStylesData] = await Promise.all([
        ...
        prisma.dressStyle.findMany({ select: { name: true }, orderBy: { name: 'asc' } })
    ]);
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-4">
                ...
                <div className="rounded-xl border bg-white p-4">
                    ...
                    <p className="text-2xl font-bold text-blue-600">{products.length} (Page)</p>
                </div>
            </div>
