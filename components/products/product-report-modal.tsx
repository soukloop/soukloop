...
export default function ProductReportModal({ productId, productName, isOpen, onClose }: ProductReportModalProps) {
    const { user } = useAuth();
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success("Report submitted. We will review this product shortly.");
            onClose();
        } catch (error: any) {
            console.error(error);
            ...
            <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
                ...
                <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <div className="flex items-center gap-2 text-red-600">
                        <Flag size={18} />
                        <h2 className="text-base font-bold text-gray-900">Report Product</h2>
                    </div>
                ...
                <div className="p-5 space-y-4">
                    <div className="bg-red-50 p-3 rounded-xl flex items-start gap-3">
                        ...
                        <p className="text-xs text-gray-700 leading-relaxed">
                            You are reporting <span className="font-bold">{productName}</span>.
